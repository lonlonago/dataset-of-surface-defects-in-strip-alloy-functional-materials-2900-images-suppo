# Dataset of surface defects in strip alloy functional materials 2900 images supports yolo

# Body

The dataset of surface defects in strip alloy functional materials, 2900 images, supports yolo format, with clear images and complete annotations, is suitable for training models for detecting surface defects in strip alloys, saving time and effort

The dataset contains various types of surface defects, which can be directly used for convenience, suitable for industrial quality inspection and other projects.
